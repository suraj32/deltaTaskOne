...
function check() {
    if (tdGroup[25].style.backgroundColor === tdGroup[6].style.backgroundColor &&
        tdGroup[26].style.backgroundColor === tdGroup[7].style.backgroundColor &&
        tdGroup[27].style.backgroundColor === tdGroup[8].style.backgroundColor &&
        tdGroup[28].style.backgroundColor === tdGroup[11].style.backgroundColor &&
        tdGroup[29].style.backgroundColor === tdGroup[12].style.backgroundColor &&
        tdGroup[30].style.backgroundColor === tdGroup[13].style.backgroundColor &&
        tdGroup[31].style.backgroundColor === tdGroup[16].style.backgroundColor &&
        tdGroup[32].style.backgroundColor === tdGroup[17].style.backgroundColor &&
        tdGroup[33].style.backgroundColor === tdGroup[18].style.backgroundColor
    ) {
        tada();
